...
export default function ResDetail({ bookingInfo }) {
  ...
  console.log("estado", infoLodging.country)
  console.log("estado", infoLodging.adress)
    ...
    <div className={styles.carouselChatContainer}>
             ...
             < hr/>
              <div className={styles.check}>
                <div className={styles.in}><span className={styles.cI}>Check-in</span>
                <span className={styles.cDate}>{new Date (bookingInfo.checkIn).toLocaleDateString()}</span></div>
                <div className={styles.out}><span  className={styles.cI}>Check-out</span>
                <span  className={styles.cDate}>{new Date (bookingInfo.checkOut).toLocaleDateString()}</span></div>
              </div>
              < hr/>
              <div className={styles.adressC}>
                <span className={styles.cD}>Tu Codigo de reserva</span>
                <span className={styles.cDate}>{infoLodging.adress}</span>
                </div>
              < hr/>
              <div className={styles.cGuests}>
                <div className={styles.nmds}>
                <span className={styles.cI}>Cantidad de Nomades</span>
                <span className={styles.cDate}>{bookingInfo.guests}</span>
                </div>
              ...
              <div className={styles.adressC}>
                <span className={styles.cD}>¿Cómo Llegar?</span>
                <span className={styles.cDate}>{infoLodging.adress}</span>
                </div>
